# Folder Structure and Coding Style Protocal
...
## Imports
Organize the imports so that longer lines are placed at the top and shorter ones at the bottom

## API in app.py
Functions in app.py that call an API should follow the naming pattern name_api
